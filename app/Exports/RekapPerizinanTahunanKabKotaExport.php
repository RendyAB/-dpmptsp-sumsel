...
class RekapPerizinanTahunanKabKotaExport implements FromView, ShouldAutoSize, WithEvents, WithColumnWidths
{
    protected $kabKotaId;
    protected $tahun;
    protected $namaWilayah;

    public function __construct($kabKotaId, $tahun, $namaWilayah)
    {
    ...
    public function view(): View
    {
        ...
        return view('exports.rekap_perizinan_tahunan_kabkota', [
            'perizinan' => $data,
