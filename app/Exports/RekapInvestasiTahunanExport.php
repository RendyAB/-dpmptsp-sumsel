...
class RekapInvestasiTahunanExport implements FromView, ShouldAutoSize, WithEvents, WithColumnWidths
{
    protected $kategori;
    protected $nama_wilayah;
    protected $tahun;

    public function __construct($kategori, $nama_wilayah, $tahun)
    {
    ...
    {
        return view('exports.rekap_investasi_tahunan', [
