...
class PerizinanProvinsiExport implements FromView, ShouldAutoSize, WithEvents, WithColumnWidths
{
    protected $triwulan, $tahun;
    ...
    public function view(): View
    {
        ...
        return view('exports.perizinan_provinsi_excel', [
