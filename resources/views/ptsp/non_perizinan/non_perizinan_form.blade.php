...
@section('titleadmin', 'Tambah Non-Perizinan - DPMPTSP Sumatera Selatan')

@section('konten')
    <div class="max-w-5xl mx-auto bg-white shadow-lg p-8 rounded-xl">

        <h1 class="text-3xl font-bold text-gray-800 mb-6">Tambah Non Perizinan</h1>

        <form action="{{ route('non_perizinan.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="col-span-2 mt-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="alamat_lokasi" class="w-full border p-2 rounded"></textarea>
                        </div>
                        ...
                        <div class="col-span-2 mt-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label class="block text-gray-700 font-medium mb-1">PDF File</label>
