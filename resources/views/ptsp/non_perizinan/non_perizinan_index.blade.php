...
@section('titleadmin', 'View Non-Perizinan - DPMPTSP Sumatera Selatan')
...
@section('konten')
    <div class="max-w-6xl mx-auto bg-white shadow-lg p-6 rounded-xl">
        ...
        <form method="GET" class="mb-5">
            <div class="flex items-center gap-3">
                <select name="status" onchange="window.location='{{ route('non_perizinan.index') }}?status=' + this.value"
        ...
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Data Non Perizinan</h1>
            <a href="{{ route('non_perizinan.create') }}"
                class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg shadow">
                + Tambah Non Perizinan
            </a>
        </div>
    ...
    <script>
        function confirmDeleteNonPerizinan(id) {
            Swal.fire({
