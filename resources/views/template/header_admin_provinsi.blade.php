...
<head>
    ...
    <title>@yield('titleadminprovinsi', 'Website Admin Provinsi - DPMPTSP Sumatera Selatan')</title>
        ...
        <div class="max-w-screen-xl mx-auto px-4 grid grid-cols-3 items-center relative">
            ...
            <div>
                <div class="flex-shrink-0">
                    ...
                    <a href="{{ route('provinsi_dashboard') }}" class="text-white font-bold text-lg">DPMPTSP Sumatera
                        Selatan</a>
                </div>
            </div>
